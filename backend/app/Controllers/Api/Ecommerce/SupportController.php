...
final class SupportController
{
    ...
    public function store(): void
    {
        ...
        $thread = $db->prepare(
            'insert into support_threads (module_key, subject, guest_id, order_id, status, created_at, updated_at)
             values (:module_key, :subject, :guest_id, :order_id, \'open\', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)'
        );
        $thread->execute([
