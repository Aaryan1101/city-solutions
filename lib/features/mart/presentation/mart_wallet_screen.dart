...
class MartWalletScreen extends StatefulWidget {
  const MartWalletScreen({super.key, required this.session});

  final MartCustomerSession session;

  @override
  State<MartWalletScreen> createState() => _MartWalletScreenState();
}

class _MartWalletScreenState extends State<MartWalletScreen> {
  final _api = MartApiClient();
  final _amountController = TextEditingController();
  final _bankController = TextEditingController();
  final _noteController = TextEditingController();
  final _formKey = GlobalKey<FormState>();
  late Future<MartWalletData> _future;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<MartWalletData>(
        future: _future,
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: const LinearGradient(
                      ...
                      colors: [Color(0xFF0B7A46), Color(0xFF20A66A)],
                    ),
                    borderRadius: BorderRadius.circular(24),
                    border: Border.all(color: Theme.of(context).dividerColor),
                    boxShadow: [
                      BoxShadow(
                        color: const Color(0xFF20A66A).withValues(alpha: .18),
                        blurRadius: 26,
    ...
    return Form(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: const Color(0xFF20A66A).withValues(alpha: .05),
              blurRadius: 18,
...
class _WithdrawalTile extends StatelessWidget {
  ...
  final MartWalletWithdrawal request;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: const Color(0xFF20A66A).withValues(alpha: .04),
            blurRadius: 16,
...
class _WalletStatusPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final color = switch (status) {
      'paid' || 'approved' => const Color(0xFF20A66A),
      'rejected' => Colors.red,
      _ => AppTheme.primary,
    };
    return Container(
      ...
      child: Row(
        children: [
          Container(
            ...
            height: 40,
            decoration: BoxDecoration(
              color: (credit ? const Color(0xFF20A66A) : Colors.red)
            ...
            children: [
              Container(
                ...
                child: const Icon(Icons.account_balance_wallet_outlined,
                    size: 34, color: Color(0xFF20A66A)),
              ),
              const SizedBox(height: 12),
              Text(title,
